...
<table align="center" cellspacing="0" style="margin-top: 15px; margin-bottom: 15px;">
    ...
    <tr>
        <td class="candidate_name">Samet Bila</td>
    ...
    <tr>
        <td class="candidate_name">Garret Dranichak</td>
        <td class="candidate_cell"></td>
        <td class="candidate_cell"></td>
        <td class="candidate_cell"></td>
        <td class="candidate_cell"><img src="/~siam/img/check.png"></td>
...
<div style="margin-top: 20px; position: relative;">
    <div style="position: relative;">
        <div id="tab_1" class="tab">
            <img id="image_1" src="samet_bila.jpg" title="Samet Bila" onClick="javascript:preview(1);">
        </div>
        <div id="tab_2" class="tab">
            <img id="image_2" src="audrey_devries.jpg" title="Audrey DeVries" onClick="javascript:preview(2);">
        </div>
        <div id="tab_3" class="tab">
            <img src="michael_dowling.jpg" title="Michael Dowling" onClick="javascript:preview(3);">
        </div>
        <div id="tab_4" class="tab">
            <img src="garret_dranichak.jpg" title="Garret Dranichak" onClick="javascript:preview(4);">
        </div>
        <div id="tab_5" class="tab">
            <img src="paul_kuberry.jpg" title="Paul Kuberry" onClick="javascript:preview(5);">
        </div>
    </div>
    <div id="info_1" class="info" style="display: none;">
        <div class="name">Samet Bila</div>
        <hr>
        <ul class="questionnaire">
            <li>
                <div class="question">Where did you attend undergrad?</div>
                <div class="response">Mimar Sinan Fine Arts University, Istanbul, Turkey</div>
            </li>
            <li>
            ...
            <li>
                ...
                <div class="response">PhD (2nd year)</div>
            </li>
            <li>
                <div class="question">What area of the US/world do you consider to be home?</div>
                <div class="response">Turkey</div>
            </li>
            <li>
                <div class="question">Why you are running?</div>
                <div class="response">To be part of the events and be more involved with Math Department.</div>
            </li>
            <li>
                <div class="question">What things are you involved with at Clemson (or were involved in during undergrad)?</div>
                <div class="response">I was part of Photography club in my undergrad. I am doing intramural for both men and coed Soccer in Clemson and I like to bike often. </div>
            </li>
            <li>
                <div class="question">What do you plan to do after you get your degree?</div>
                <div class="response">In the future, I would probably like to return to my country and work in a university as a professor. </div>
            </li>
        </ul>
    </div>
    <div id="info_2" class="info">
        ...
        <ul class="questionnaire">
            ...
            <li>
                <div class="question">Are you currently working on a MS or a PhD?</div>
                <div class="response">MS (2nd year)</div>
            </li>
            <li>
                <div class="question">What area of the US/world do you consider to be home?</div>
    ...
    <div id="info_3" class="info" style="display: none;">
        ...
        <ul class="questionnaire">
            ...
            <li>
                <div class="question">Are you currently working on a MS or a PhD?</div>
                <div class="response">PhD (4th year)</div>
            </li>
            <li>
                <div class="question">What area of the US/world do you consider to be home?</div>
    ...
    <div id="info_4" class="info" style="display: none;">
        <div class="name">Garret Dranichak</div>
        <hr>
        <ul class="questionnaire">
            <li>
                <div class="question">Where did you attend undergrad?</div>
                <div class="response">Pfeiffer University (Misenheimer, NC)</div>
            </li>
            <li>
                <div class="question">What is your concentration area at Clemson?</div>
                <div class="response">Operations Research</div>
            ...
            <li>
                <div class="question">What area of the US/world do you consider to be home?</div>
                <div class="response">Dublin, Ohio</div>
            </li>
            <li>
                <div class="question">Why you are running?</div>
                <div class="response">I am hoping to contribute more to the department and more to the organizations that help to support the graduate students. A great way for me to do this is by acting in a leadership role with Clemson's student chapter of SIAM.</div>
            </li>
            <li>
                <div class="question">What things are you involved with at Clemson (or were involved in during undergrad)?</div>
                <div class="response">As an undergraduate, I tutored university and high school students through the math department, organized calculus study sessions, and participated in the Calculus Calculator Workshop day at Stanly County High School. As a graduate student, I have helped during the "Math-In" final exam study sessions, and I have volunteered for the Clemson Calculus Challenge.</div>
            </li>
            <li>
                <div class="question">What do you plan to do after you get your degree?</div>
                <div class="response">I would like to continue the teaching experience I have gained here at Clemson by working as a professor at a small college or university.</div>
            </li>
        </ul>
    </div>
    <div id="info_5" class="info" style="display: none;">
        ...
        <ul class="questionnaire">
            ...
            <li>
                <div class="question">What things are you involved with at Clemson (or were involved in during undergrad)?</div>
                <div class="response">I was the president of the mathematics club at Clarion University and served as the president for SIAM this year.</div>
            </li>
            <li>
                <div class="question">What do you plan to do after you get your degree?</div>
