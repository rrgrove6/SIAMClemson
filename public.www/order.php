...
if(isset($_POST['submit_order']) && ($_POST['submit_order'] == 1))
{
	...
	// place order
	$query = "SELECT * FROM items WHERE remaining > 0";
	$result = mysql_query($query, $link);
	$item_ids = array();
...
{
	$link = db_connect();
	$query="SELECT * FROM items WHERE remaining > 0 Order By display_order";
...
<tr>
	<td colspan="2" style="border-right: solid 2px #ff6206; border-bottom: none; border-left: solid 2px #ff6206; border-top: solid 2px #ff6206; padding-top: 5px; padding-left: 5px; padding-right: 5px;"><img src="img/2010_shirt_short_sleeve.png"></td>
</tr>
<tr>
	<td colspan="2" style="border-right: solid 2px #ff6206; border-bottom: none; border-left: solid 2px #ff6206; border-top: none; padding-top: 5px; padding-left: 5px; padding-right: 5px;"><img src="img/2010_shirt_long_sleeve.png"></td>
</tr>
<tr>
	<td colspan="2" style="text-align: center; font-size: 20px; border-right: solid 2px #ff6206; border-top: none; border-left: solid 2px #ff6206; border-bottom: solid 1px #ff6206;">2010 T-shirts</td>
</tr>
<tr>
...
<tr>
	<td colspan="2" style="border-right: solid 2px #ff6206; border-top: none; border-left: solid 2px #ff6206; border-bottom: none; padding-top: 5px; padding-left: 5px; padding-right: 5px;"><img src="img/2009_shirt.png"></td>
</tr>
<tr>
	<td colspan="2" style="text-align: center; font-size: 20px; border-right: solid 2px #ff6206; border-top: none; border-left: solid 2px #ff6206; border-bottom: solid 2px #ff6206;">2009 T-shirts</td>
</tr>
</table>
<form name="order" method="POST" action="order.php">
<table align="center" style="text-align: left;">
<tr>
	<td style="text-align: center; width: 300px; font-weight: bold;">Item Description</td>
...
<tr>
	<td colspan="3" style="text-align: center;"><input type="hidden" name="submit_order" value="1"><input type="submit" value="Place Order"></td>
</tr>
</table>
</form>
<?php
